...
export const useHeroAnimations = () => {
  ...
  const animateCharlesAndYouElements = () => {
    ...
    const charlesElement = document.querySelector(
      '.charles-point-right-wrapper.hero-left'
    ) as HTMLElement
    const youElement = document.querySelector(
      '.charles-point-left-wrapper.hero-right'
    ) as HTMLElement
    ...
    if (charlesElement && youElement) {
      ...
      const timer1 = setTimeout(() => {
        charlesElement.style.transition =
      ...
      const charlesElements = document.querySelectorAll(
        '.charles-point-right-wrapper, .hero-2-arrow-button .charles-point-right-wrapper'
  ...
  const animateHeroArrows = () => {
    const arrows = document.querySelectorAll(
      '.charles-point-right-icon, .charles-point-left-icon, .hero-2-arrow-button .charles-point-right-icon'
    )
  ...
  const animateHeroBottomArrows = () => {
    const heroBottomRightIcon = document.querySelector(
      '.hero-bottom-right-icon[data-w-id="dca238e7-d096-a005-69db-d020ae18b69c"]'
    ) as HTMLElement
    const heroBottomLeftIcon = document.querySelector(
      '.hero-bottom-left-icon'
    ) as HTMLElement

    if (heroBottomRightIcon) {
      const timer1 = setTimeout(() => {
        heroBottomRightIcon.style.animation =
    ...
    if (heroBottomLeftIcon) {
      const timer2 = setTimeout(() => {
        heroBottomLeftIcon.style.animation =
          'arrowPulse 2.5s ease-in-out infinite 1.25s'
      }, 1700)
  ...
  const addCharlesYouInteractions = () => {
    ...
    const charlesWrapper = document.querySelector(
      '.charles-point-right-wrapper.hero-left'
    ) as HTMLElement
    const youWrapper = document.querySelector(
      '.charles-point-left-wrapper.hero-right'
    ) as HTMLElement
