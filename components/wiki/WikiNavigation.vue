<template>
  <div
    class="wiki-navigation bg-[#FCFAF9] text-gray-800 p-6 rounded-md h-full" 
  >
    <NuxtLink
      v-if="navTitle"
      to="/wiki"
      prefetch
      class="block text-brandNeutral-04 hover:bg-purple-light hover:text-primary-700 p-1 rounded-md transition-colors duration-150 -ml-1 -mr-1 mb-0.5"
    >
      ...
      >
        ...
        >
          ...
          <ul
            ...
            class="ml-4 mt-1 pl-3 border-l border-primary-200 space-y-0"
          >
            <NavItemRecursive
