<template>
  ...
  >
    ...
    >
      <div
        class="px-1 h-4 text-base font-bold tracking-wide leading-4 text-white uppercase border-white cursor-pointer outline-white select-none decoration-white duration-&lsqb;0.2s&rsqb; rounded-[30px] w-[29px] [font-variant-ligatures:stylistic] [font-feature-settings:'ss01']"
        :class="modelValue ? 'bg-primary-700' : 'bg-primary-400'"
      >
        <div
          class="absolute inset-y-0 my-auto ml-2 w-2.5 h-2.5 text-base font-bold tracking-wide leading-none text-white uppercase border-white transition-opacity cursor-pointer outline-white select-none decoration-white duration-&lsqb;0.25s&rsqb; [font-variant-ligatures:stylistic] [font-feature-settings:'ss01']"
        />
        <div
          class="bottom-0 my-auto mr-2 w-2.5 h-2.5 text-base font-bold tracking-wide leading-none text-white uppercase border-white opacity-0 transition-opacity cursor-pointer outline-white select-none decoration-white duration-&lsqb;0.25s&rsqb; [font-variant-ligatures:stylistic] [font-feature-settings:'ss01']"
        />
      </div>
      <div
