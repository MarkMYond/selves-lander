<template>
  ...
  >
    <div
      class="relative px-4 mx-auto max-sm:w-full max-sm:max-w-full"
      :class="containerClass"
    >
      <div
        class="bg-brand-100 rounded-xl px-12 py-20 relative overflow-hidden min-h-[320px]"
      >
        <div class="absolute top-0 left-0 w-full h-full pointer-events-none">
          <svg
            class="absolute top-0 left-0 w-64 h-64"
            viewBox="0 0 100 100"
          >
            <path
              d="M100,0 C100,60 0,60 0,100"
              stroke="#1F1F1F"
              fill="none"
              stroke-width="1.5"
            />
        ...
        <div
          ...
          class="text-center relative z-10 max-w-4xl mx-auto"
        >
          <blockquote
            v-if="currentTestimonial.quote"
            class="text-2xl italic text-[#2C2C2C] font-medium leading-relaxed mb-12"
          >
          ...
          <div class="flex flex-col items-center">
            ...
            <div
              v-if="currentTestimonial.authorTitle"
              class="text-[#2C2C2C] text-md mt-1"
            >
        ...
        <div
          v-else
          class="text-center italic text-gray-500 py-12"
        >
        ...
        <div
          v-if="totalSlides > 1"
          class="absolute bottom-12 left-0 right-0 flex justify-between items-center px-12 z-10"
        >
          <div class="flex items-center gap-2">
            <button
              ...
              :class="
                currentSlide === index - 1 ? 'bg-[#2C2C2C]' : 'bg-[#D0D0D0]'
              "
          ...
          <div class="flex items-center">
            <div class="w-20 h-px bg-[#D0D0D0] mr-3" />
...
const sectionBgClass = computed(() => {
  switch (props.block?.sectionBackgroundColor) {
    ...
    default:
      return 'bg-brand-50' // Default based on original static code
  }
})
...
const containerClass = computed(() => {
  ...
  switch (props.block?.containerWidth) {
    ...
    case 'full':
      return 'max-w-none'
    default:
      return 'max-w-7xl' // Default to wide for the inner content
  }
})
</script>
