  ...
  <li class="flex items-center text-sm text-gray-700 dark:text-gray-300 py-1">
    <template v-if="availability === 'included'">
      <Icon
        ...
        class="mr-2 h-5 w-5 text-green-500 flex-shrink-0"
      />
    ...
    <template v-else-if="availability === 'not_included'">
      <Icon
        ...
        class="mr-2 h-5 w-5 text-red-400 flex-shrink-0"
      />
    ...
    <Icon
      v-if="tooltip"
      name="ph:info"
      class="ml-1 h-4 w-4 text-gray-400 dark:text-gray-500 cursor-help flex-shrink-0"
      :title="tooltip"
    />
  </li>
</template>
