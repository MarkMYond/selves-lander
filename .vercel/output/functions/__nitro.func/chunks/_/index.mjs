...
const require$$0 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(googleAuthLibrary);

const require$$1 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(ws);

const require$$2 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(promises);

(function (exports) {

	var googleAuthLibrary = require$$0;
	var NodeWs = require$$1;
	var fs = require$$2;
