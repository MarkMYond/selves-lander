// Import the genai package correctly
...
export default defineEventHandler(async (event) => {
  try {
    ...
    // Set up system prompt based on travel era
    let systemPrompt = '';
    ...
    // Use the generative model best suited for chat
    ...
    const chat = model.startChat({
      history: [
        {
          role: 'user',
          parts: [{ text: 'Please act as a travel agent for the specific era I mentioned. Stay in character throughout our conversation.' }],
        },
        {
          role: 'model',
          parts: [{ text: 'I understand. I will stay in character as a travel agent from the specified era throughout our conversation.' }],
        },
        ...history
      ],
