...
module.exports = {
  ...
  safelist: [
    ...
    // {
    //   // Existing primary colors - Commented out as 'primary' doesn't have these shades defined
    ...
    // },
    {
      ...
      pattern:
        /^bg-(sand|pink-light|coral-light|pink-mid|purple-light|blue-light|aqua-light|green-light|light-green|grass-light|navy-dark)$/, // Removed light-grey from pattern if explicitly listed
    },
  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        'accordion-down':
          'accordion-down 200ms cubic-bezier(0.215, 0.61, 0.355, 1)',
        'accordion-up':
          'accordion-up 200ms cubic-bezier(0.215, 0.61, 0.355, 1)',
      },
      typography: ({ theme }) => ({
        DEFAULT: {
          // Standard prose styles
          css: {
            ...
            'li > p': {
              // If paragraphs are nested inside list items
        ...
        xl: {
          ...
          css: {
            ...
            h2: {
              // Adjust H2 size for larger context if needed
            ...
            h3: {
              // Adjust H3 size for larger context
